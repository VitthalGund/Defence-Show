        ...
        <div className="carousel">
          <div className="carousel__wrapper">
            <div className="carousel__header">
              <h2 className="carousel__headline">Our Lasted Uploads</h2>
            ...
            <ul className="carousel__content">
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=2"
              ...
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=3"
                  title="YouTube video player"
                  allowFullScreen
                  loading="lazy"
                ></iframe>
              ...
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=4"
                  title="YouTube video player"
                  allowFullScreen
                  loading="lazy"
                ></iframe>
              ...
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=5"
                  title="YouTube video player"
                  allowFullScreen
                  loading="lazy"
                ></iframe>
              ...
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=6"
                  title="YouTube video player"
                  allowFullScreen
                  loading="lazy"
                ></iframe>
              ...
              <li className="carousel__item">
                <iframe
                  height={250}
                  width={350}
                  src="https://www.youtube.com/embed?listType=playlist&list=UUzpGkJGCGGA106WJvxzc3lQ&index=7"
                  title="YouTube video player"
                  allowFullScreen
                  loading="lazy"
                ></iframe>
